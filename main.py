...
class Ticket:
    ...
    def bookTicket(self):
        ...
        for event in eventdetails:
            print("Available Event Code : " + event.eventcode +
...
class Event:
    ...
    def createEvent(self):
        ...
        self.eventTotalAvaibleSeat = input(
            "Enter Event Total Availble Seats: ")
        print("\n\n ------> Event Created!")
...
def getEventsDetails():
    ...
    if file.exists():
        ...
        eventdetails = pickle.load(infile)
        print("---------------EVENT DETAILS---------------------")
        print("Event-Name    Event-Code    Event-Total-Seats")
        for event in eventdetails:
...
def getEventsSummary():
    ...
    if fileEvents.exists():
        ...
        for event in eventdetails:
            print("\n\nEvent Name : " + event.eventname +
                  " | Total Seats : " + event.eventTotalAvaibleSeat + " \n")
            for ticket in ticketdetails:
